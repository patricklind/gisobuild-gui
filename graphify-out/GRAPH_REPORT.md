...
Cohesion: 0.09
Nodes (32): active_rpm_names(), add_superseded_exclusions(), build_cleanup_paths(), build_command(), build_plan(), child_mount_args(), confidence_report(), create_build_plan() (+24 more)
...
### Community 47 - "app.py"
Cohesion: 0.11
Nodes (32): errorhandler, get, activity(), archive_checksums(), archive_delete(), archive_download(), archive_list(), bad_request() (+24 more)
...
Cohesion: 0.17
Nodes (21): Exception, append_activity(), cisco_accept(), cisco_client(), cisco_download_start(), cisco_failure(), cisco_response_requires(), cisco_search() (+13 more)
