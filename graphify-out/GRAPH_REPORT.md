...
Cohesion: 0.10
Nodes (28): active_rpm_names(), add_superseded_exclusions(), build_plan(), confidence_report(), create_build_plan(), current_inventory_revision(), discover(), inspect_iso_architecture() (+20 more)
...
### Community 45 - "Path"
Cohesion: 0.12
Nodes (23): delete, archive_giso_artifacts_and_cleanup(), archive_source_for_extraction(), build_cleanup_paths(), cancel_upload(), command_preview(), delete_upload(), extract_cisco_archive() (+15 more)

### Community 47 - "app.py"
Cohesion: 0.10
Nodes (36): errorhandler, get, activity(), archive_checksums(), archive_delete(), archive_download(), archive_list(), archive_size() (+28 more)

### Community 48 - "build_command"
Cohesion: 0.20
Nodes (10): build_command(), child_mount_args(), glob_metacharacters(), RuntimeError, Share only required storage with the build container, never docker.sock., Resolve opaque inventory IDs, retaining legacy exact basenames temporarily., resolve_rpm_identifiers(), validate_archive_retention_days() (+2 more)

### Community 50 - "run_cisco_download"
Cohesion: 0.19
Nodes (21): Exception, append_activity(), cisco_accept(), cisco_client(), cisco_download_running(), cisco_download_start(), cisco_failure(), cisco_response_requires() (+13 more)

### Community 51 - "create_job"
Cohesion: 0.18
Nodes (16): after_request, append_log(), BuildCancelled, cancel_job(), cancellation_requested(), create_job(), log_event(), persist_job() (+8 more)
...
## Knowledge Gaps
- **230 isolated node(s):** `inputs`, `platformProfiles`, `CONFIDENCE_LABELS`, `READY_CHECK_LABELS`, `drop` (+225 more)
