...
for command in ("show version", "show platform", "show redundancy",
                "show alarms brief system active", "show install request",
                "install package replace /harddisk:/staging-giso.iso",
                "install apply reload", "show version", "install commit",
                "install package rollback 1", "install apply rollback reload",
